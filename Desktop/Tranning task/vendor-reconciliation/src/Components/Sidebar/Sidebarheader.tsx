...
const SidebarHeader = ({ collapsed }: any) => (
    <div style={{ background: '#fff', padding: 10, display: 'flex', alignItems: 'center', transition: 'width 0.2s' }}>
        <Space>
            ...
            {!collapsed && <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 150, fontSize: "14px", fontWeight: "700", textAlign: "center" }}>Vendor Reconciliation</div>}
        </Space>
    </div>
);
